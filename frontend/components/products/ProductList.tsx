...
const ProductList = () => {
  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 lg:px-6 py-4 bg-slate-100">
            ...
            >
              ...
              <div className="p-4">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <button className="text-sm font-medium text-white bg-emerald-600 hover:bg-emerald-700 px-4 py-2 rounded-lg transition-colors duration-200">
                    View Details
                  </button>
                </div>
              </div>
